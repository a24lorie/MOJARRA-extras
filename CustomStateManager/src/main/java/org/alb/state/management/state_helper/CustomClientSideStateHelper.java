...
public class CustomClientSideStateHelper extends ClientSideStateHelper {
    ...
    public CustomClientSideStateHelper(String writerType) {
        super();
    ...
    public Object getState(FacesContext ctx, String viewId) throws IOException {
        ...
        if ("stateless".equals(stateString)) {
            ...
            stateString = stateWritter.readState(stateString).toString();
            if (stateString == null) {
                return null;
            }
        }
    ...
    public void writeState(FacesContext ctx,Object state,StringBuilder stateCapture) throws IOException {
        ...
        if (stateCapture != null) {
            ...
            String stateId = ((HttpServletRequest) ctx.getExternalContext().getRequest()).getSession().getId() + ":" + createRandomId();
            stateWritter.writeState(stateId, stateBuilder.toString());
